...
export default function FeaturedProject({ content, index }) {
    ...
    return (
        <m.section
            ...
            animate={controls}
        >
            <a href={url} target="_blank" rel="noopener noreferrer" className={css.projectLink}>
                <div className={css.details}>
                    <div className={css.projectHeader}>
                        <div className={css.header}>
                            <h3 className="highlight">{project}</h3>
                            <span className={css.privateOr}><i className="devicon-github-plain"></i>{repoVisability}</span>
                        </div>
